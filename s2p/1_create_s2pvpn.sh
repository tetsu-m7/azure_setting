...
#az group create --name s2pTest --location EastUS
...
pip=$( az network public-ip create --name VNet1GWpip --resource-group s2pTest --location EastUS --allocation-method Static --sku standard)
